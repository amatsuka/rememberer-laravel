 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function notFound($data = [], $message = 'Not found', $code = 404)
        {
                        return \Illuminate\Routing\ResponseFactory::notFound($data, $message, $code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function error($data = [], $message = 'Application Error', $code = 400)
        {
         ...
         * @static 
         */ 
        public static function fail($data = [], $message = 'Server Error', $code = 500)
        {
         ...
         * @static 
         */ 
        public static function forbidden($data = [], $message = 'Access denied', $code = 403)
        {
